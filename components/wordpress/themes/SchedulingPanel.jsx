...
import { SCHEDULING_DEFAULTS, UPDATE_FREQUENCIES } from '@/lib/wordpressThemesDummyData'
...
/** Scheduling tab: automatic theme updates, frequency, maintenance window, preferred time, safe mode, notifications. */
export default function SchedulingPanel({ onSave }) {
  ...
  return (
    <Card className="p-6 flex flex-col gap-3">
      <h3 className="text-sm font-semibold mb-1">Theme Update Scheduling</h3>

      <SettingRow label="Automatic Theme Updates" description="Automatically install available theme updates">
      ...
      <SettingRow label="Email Notifications" description="Get notified after each update run">
