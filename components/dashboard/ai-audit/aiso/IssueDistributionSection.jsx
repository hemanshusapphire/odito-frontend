...
const SEVERITY_ROWS = [
  {
    ...
    desc:    "Blocks AI crawlers from discovering or indexing this content.",
    Icon:    ShieldAlert,
  ...
  },
  {
    key:     "high",
    label:   "High Severity",
    desc:    "Significantly degrades citation attribution and semantic scoring.",
    Icon:    AlertTriangle,
  ...
  },
  {
    ...
    desc:    "Optimization opportunities for AI context and entity coverage.",
    Icon:    Settings2,
...
/**
 * IssueDistributionSection
 *
 * Props:
 *   distribution — { total, critical, high, medium, low }
 */
export default function IssueDistributionSection({ distribution }) {
