...
const SEVERITY_ROWS = [
  {
    ...
    desc: "Blocks AI answer extraction entirely.",
    Icon: ShieldAlert,
  ...
  },
  {
    key: "high",
    label: "High Severity",
    desc: "Significantly degrades snippet ranking.",
    Icon: AlertTriangle,
  ...
  },
  {
    ...
    desc: "Optimization opportunities for broad queries.",
    Icon: Settings2,
...
export default function AEOIssueDistribution({ distribution }) {
