 ...
 * lib/businessProfileActivity.js) - Google exposes no general activity/audit
 * log API for Business Profile, so this is never fabricated: an event only
 * appears once its underlying sync has actually run.
 */
export default function RecentActivityCard({ activity }) {
  return (
    <Card className="p-6">
      <h3 className="text-sm font-semibold">Recent Activity</h3>
      <p className="text-xs text-muted-foreground mt-0.5">Latest sync activity for your profile</p>
