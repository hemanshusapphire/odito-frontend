...
import GeoHubPageContent from "@/components/dashboard/ai-audit/geo/GeoHubPageContent"
...
import { useGEOHubIssueDetail, usePageAIIssues } from "@/hooks/useDashboardQueries"

function GeoHubContent() {
  ...
  const { data: detailResponse, isLoading: detailLoading } = useGEOHubIssueDetail(
  ...
  const handleBack = () => router.push('/app/geo-hub')
  ...
  if (ruleId) {
    ...
    return (
      <UnifiedIssueDetailView
        ...
        issueTypeName="GEO Hub"
      />
    )
  }

  // ── Hub dashboard ────────────────────────────────────────────────────────
  return <GeoHubPageContent />
}
