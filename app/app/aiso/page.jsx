...
import AISOHubPageContent from "@/components/dashboard/ai-audit/AISOHubPageContent"
...
import { useAISOHubIssueDetail, usePageAIIssues } from "@/hooks/useDashboardQueries"

function AISOHubContent() {
  ...
  const { data: detailResponse, isLoading: detailLoading } = useAISOHubIssueDetail(
  ...
  const handleBack = () => router.push('/app/aiso')
  ...
  // ── Hub dashboard ────────────────────────────────────────────────────────
  return <AISOHubPageContent projectId={projectId} />
}
