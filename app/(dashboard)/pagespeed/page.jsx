...
import PageSpeedPageContent from "@/components/dashboard/pagespeed/PageSpeedPageContent"
    ...
    <Suspense fallback={
      <div className="space-y-4 skeleton-fade-in">
        ...
        <div className="rounded-xl border p-6">
          <div className="w-full h-48 skeleton-base skeleton-shimmer rounded" />
        </div>
      </div>
    }>
      <PageSpeedPageContent />
    </Suspense>
  )
}
