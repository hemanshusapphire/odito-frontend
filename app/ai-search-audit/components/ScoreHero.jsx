    ...
    <div className={styles.scoreHero}>
      ...
      <div className={styles.scoreHeroRing}>
        ...
        <svg width="150" height="150" viewBox="0 0 120 120">
          ...
          <circle cx="60" cy="60" r={ringR} fill="none" stroke="var(--color-score-ring-track, rgba(17, 17, 17, 0.06))" strokeWidth="9" />
      ...
      <div className={styles.scoreHeroText}>
        ...
        <div className={styles.scoreHeroDesc}>
          ...
          <strong style={{ color: "var(--amber)" }}>{aiData?.critical_issues} critical issues</strong>{" "}
